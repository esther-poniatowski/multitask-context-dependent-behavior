...
class EnsembleAssigner(Processor):
    ...
    def eval_n_ensembles(self, n_units: int) -> int:
        ...
        Notes
        -----
        This method is not used for the computation of the ensembles, but can be useful to assess
        the resulting number of ensembles that will be generated by the processor, for instance to
