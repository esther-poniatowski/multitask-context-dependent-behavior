...
See Also
--------
:mod:`utils.misc.sequences`: Tested module.
"""

import numpy as np
import pytest

from utils.misc.sequences import unique, reverse_dict_container
...
def test_unique(sequence, expected_output):
    """
    Test for :func:`utils.misc.sequences.unique`.
...
def test_reverse_dict_container():
    """
    Test for :func:`utils.misc.sequences.reverse_dict_container`
