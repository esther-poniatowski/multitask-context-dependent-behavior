...
class FoldAssignerInputs(ProcessorInput):
    ...
    strata: Strata
        Labels of strata for stratified assignment. Shape: ``(n_samples,)``. If not provided, all
        samples are treated as belonging to a single stratum based on the number of samples.
    """
