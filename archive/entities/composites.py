...
# -*- coding: utf-8 -*-
"""
`core.entities.composites` [module]
...
from attributes.brain_info import Animal, Area, CorticalDepth, Training
from core.attributes.exp_condition import Context, Task, Stimulus
from core.attributes.exp_structure import Block, Slot, Recording
