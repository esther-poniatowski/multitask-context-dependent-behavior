...
class EnsembleAssignerInputs(ProcessorInput):
    ...
    def validate(self, ensemble_size: int = 0, **config_params: Any) -> None:
        """
        ...
        ---------
        ensemble_size: int
            See :attr:`EnsembleAssigner.ensemble_size``
        ...
        """
        if self.n_units < ensemble_size:
            raise ValueError(f"n_units: {self.n_units} < ensemble_size: {ensemble_size}")
...
class EnsembleAssigner(Processor):
    ...
    def eval_n_ensembles(ensemble_size: int, n_units: int, n_ensembles_max: int) -> int:
        ...
        ---------
        ensemble_size : int
            See the configuration parameter :attr:`EnsembleAssigner.ensemble_size`.
        n_units : int
            See the argument :ref:`EnsembleAssignerInputs.n_units`.
        n_ensembles_max : int
            See the configuration parameter :attr:`EnsembleAssigner.n_ensembles_max`.
    ...
    def assign(self, n_units: int) -> Ensembles:
        ...
        -------
        ensembles : Ensembles
            See the output :ref:`EnsembleAssignerOutputs.ensembles`.
